...
//     const currunt=cdate.getFullYear();
//     const bday=bdate.getFullYear();
//       setyear(currunt-bday);
//   }
//   return (
//     <div className="App">
//       <input type='date'  onChange={(e)=>{setbdate(e.target.value)}}></input>
//       <input type='date' onChange={(e)=>{setcdate(e.target.value)}}></input>
//       <input type='button'value={"click Here"} onClick={()=>calc()}></input>
